...
type Extraction = {
  title?: string; dates?: { date: string; start_time?: string | null; end_time?: string | null }[];
...
export function ReviewForm({ ingestion, event, occurrences, municipalities, places, candidates }: {
  ...
  const [organizer, setOrganizer] = useState(ingestion.organizer_hint ?? ex.organizer ?? "");
  ...
  function payload() {
    return {
      ...
      placeId, placeText, municipality, isFree,
